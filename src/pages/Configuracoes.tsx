...
export default function Configuracoes() {
  ...
  const [subTabUsuarios, setSubTabUsuarios] = useState<SubTabUsuarios>(() => {
    return searchParams.get('tab') === 'permissoes' ? 'permissoes' : 'lista';
  });
    ...
    <div className="space-y-6">
      ...
      {activeTab === 'usuarios' && (
        <div className="space-y-4">
          ...
          {/* VISÃO 2: MATRIZ DE ACESSOS / PERMISSÕES */}
          {subTabUsuarios === 'permissoes' && (
            <div className="space-y-6">
              <div className="bg-white p-5 rounded-2xl shadow-xs border border-slate-200">
                ...
                <p className="text-slate-500 text-xs mb-4">
                  Selecione um colaborador para configurar quais módulos ele terá permissão para visualizar e operar.
                </p>
