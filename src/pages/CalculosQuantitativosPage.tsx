            ...
            <form onSubmit={handleConfirmCreate} className="space-y-4 text-xs">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="col-span-2">
                  ...
                  <input type="text" disabled value={newOrcamentoData.cidade || ''} placeholder="Preenchido automaticamente..." className="w-full px-3 py-2 border border-slate-200 rounded-xl text-slate-700 font-semibold bg-slate-100 cursor-not-allowed" />
                </div>
                <div>
